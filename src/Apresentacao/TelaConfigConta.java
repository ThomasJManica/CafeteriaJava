...
public class TelaConfigConta extends javax.swing.JFrame {
    ...
    public TelaConfigConta(int idDoUsuario) {
    ...
    private void initComponents() {
        ...
        TextoSenhaAtual = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        TextoSenhaNova = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        TextoConfirmarSenha = new javax.swing.JTextField();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Usuarios.DeletarConta(idDoUsuario);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JFrame telaUsuario = new TelaUsuarios(idDoUsuario);
        telaUsuario.setVisible(true);
        setVisible(false);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        RealizarCadastro.AlterarSenha(idDoUsuario, TextoSenhaAtual.getText(), TextoSenhaNova.getText(), TextoConfirmarSenha.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConfigConta(0).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField TextoConfirmarSenha;
    private javax.swing.JTextField TextoSenhaAtual;
